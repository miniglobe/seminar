...
function sydney_toolbox_register_projects() {
	...
	$slug = apply_filters( 'sydney_projects_rewrite_slug', 'course' );	

	$labels = array(
		'name'                  => _x( 'Courses', 'Post Type General Name', 'sydney_toolbox' ),
		'singular_name'         => _x( 'Course', 'Post Type Singular Name', 'sydney_toolbox' ),
		'menu_name'             => __( 'コース一覧', 'sydney_toolbox' ),
		'name_admin_bar'        => __( 'Courses', 'sydney_toolbox' ),
		'archives'              => __( 'Item Archives', 'sydney_toolbox' ),
		'parent_item_colon'     => __( 'Course Item:', 'sydney_toolbox' ),
		'all_items'             => __( 'All Courses', 'sydney_toolbox' ),
		'add_new_item'          => __( 'Add New Course', 'sydney_toolbox' ),
		'add_new'               => __( 'Add New Course', 'sydney_toolbox' ),
		'new_item'              => __( 'New Course', 'sydney_toolbox' ),
		'edit_item'             => __( 'Edit Course', 'sydney_toolbox' ),
		'update_item'           => __( 'Update Course', 'sydney_toolbox' ),
		'view_item'             => __( 'View Course', 'sydney_toolbox' ),
		'search_items'          => __( 'Search Course', 'sydney_toolbox' ),
	...
	$args = array(
		'label'                 => __( 'Course', 'sydney_toolbox' ),
		'description'           => __( 'A post type for your courses', 'sydney_toolbox' ),
		'labels'                => $labels,
